...
let CardRepository = class CardRepository {
    create(card) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield card_model_1.Card.create(card);
        });
    }
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield card_model_1.Card.findByPk(id);
        });
    }
    update(card) {
        return __awaiter(this, void 0, void 0, function* () {
            yield card_model_1.Card.update(card, {
                where: {
                    id: card.id
                }
            });
            return yield this.findById(card.id);
        });
    }
};
